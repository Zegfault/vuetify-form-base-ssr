'use strict';var Vue=require('vue');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var Vue__default=/*#__PURE__*/_interopDefaultLegacy(Vue);function ownKeys$1(object, enumerableOnly) {
...
var script = {
  ...
  computed: {
    ...
    flatCombinedArraySorted: function flatCombinedArraySorted() {
      return lodash.orderBy(this.flatCombinedArray, ["schema.sort"], [orderDirection]);
    },
  ...
  methods: {
    ...
    mapTypeToComponent: function mapTypeToComponent(type) {
      ...
      var allTypeComponents = _objectSpread2$1(_objectSpread2$1({}, typeToComponent), Vue__default['default'].options.components); // const typeToComponent -> maps type to according v-component
    ...
    bindSchemaText: function bindSchemaText(obj) {
      return _objectSpread2$1(_objectSpread2$1({}, defaultPickerSchemaText), obj.schema.text);
    },
    bindSchemaMenu: function bindSchemaMenu(obj) {
      return _objectSpread2$1(_objectSpread2$1({}, defaultPickerSchemaMenu), obj.schema.menu);
    },
    ...
    getShorthandTooltip: function getShorthandTooltip(schemaTooltip) {
      ...
      return lodash.isString(schemaTooltip) ? {
        bottom: true,
        label: schemaTooltip
      } : schemaTooltip;
    },
    getShorthandTooltipLabel: function getShorthandTooltipLabel(schemaTooltip) {
      ...
      return lodash.isString(schemaTooltip) ? schemaTooltip : schemaTooltip && schemaTooltip.label;
    },
    //
    // FORM SLOTS
    ...
    getGridAttributes: function getGridAttributes(obj) {
      ...
      lodash.isPlainObject(colSchema) ? colSchema : lodash.isNumber(colSchema) || lodash.isString(colSchema) ? {
        cols: colSchema
      } : {
        cols: "auto"
      } : // else use formbase attribute definition of cols
      colAttr ? lodash.isPlainObject(colAttr) ? colAttr : lodash.isNumber(colAttr) || lodash.isString(colAttr) ? {
        cols: colAttr
      } : {
        cols: "auto"
      ...
      var offsetObject = offset ? lodash.isPlainObject(offset) ? offset : {
        offset: offset
      } : offset;
      ...
      var orderObject = order ? lodash.isPlainObject(order) ? order : {
        order: order
      } : order;
      this.gridMapper(orderObject, "order-");
      this.gridReplaceXS(orderObject, "order");
      return _objectSpread2$1(_objectSpread2$1(_objectSpread2$1({}, colObject), offsetObject), orderObject);
    },
    ...
    toCtrl: function toCtrl(params) {
      ...
      return params.obj.schema && lodash.isFunction(params.obj.schema.toCtrl) ? params.obj.schema.toCtrl(params) : params.value;
    },
    fromCtrl: function fromCtrl(params) {
      ...
      return params.obj.schema && lodash.isFunction(params.obj.schema.fromCtrl) ? params.obj.schema.fromCtrl(params) : params.value;
    },
    dropCtrl: function dropCtrl(params) {
      ...
      return params.obj.schema && lodash.isFunction(params.obj.schema.drop) ? params.obj.schema.drop(params) : params.value;
    },
    //
    // Drag / Drop / DropValue
    ...
    drop: function drop(event, obj) {
      ...
      if (lodash.isFunction(obj.schema.drop)) {
    ...
    onEvent: function onEvent() {
      ...
      lodash.delay(function () {
        _this.emitValue(event.type, emitObj);
      });
      return emitObj;
    },
    onClickOutside: function onClickOutside(event, obj) {
      ...
      if (lodash.isFunction(obj.schema.clickOutside)) {
    ...
    updateArrayFromState: function updateArrayFromState(data, schema) {
      this.flatCombinedArray.forEach(function (obj) {
        obj.value = lodash.get(data, obj.key, null); // get - lodash

        obj.schema = lodash.get(schema, obj.key, null); // get - lodash
      });
    },
    ...
    flattenObjects: function flattenObjects() {
      ...
      Object.keys(sch).forEach(function (key) {
        ...
        var datObjectWithoutSchemaType = lodash.isPlainObject(dat[key]) && !sch[key].type;
    ...
    tryAutogenerateModelStructure: function tryAutogenerateModelStructure(model, schema) {
      ...
      Object.keys(schema).forEach(function (key) {
        ...
        if (val.type === "group") {
          ...
          _this5.$set(model, key, []);
        } else if (lodash.isPlainObject(val) && !val.type) {
          _this5.$set(model, key, {});
    ...
    rebuildArrays: function rebuildArrays(model, schema) {
      ...
      if (lodash.isEmpty(schema) && lodash.isEmpty(model)) {
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('v-row', _vm._b({
  ...
  }, 'v-row', _vm.getRow, false), [_vm._t(_vm.getFormTopSlot(), null, {
    "id": _vm.id
  }), _vm._v(" "), _vm._l(_vm.flatCombinedArraySorted, function (obj, index) {
    return [_c('v-tooltip', _vm._b({
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(ref) {
          var on = ref.on;
          return [_c('v-col', _vm._g(_vm._b({
            directives: [{
              name: "show",
              rawName: "v-show",
              value: !obj.schema.hidden,
              expression: "!obj.schema.hidden"
            }, {
              name: "intersect",
              rawName: "v-intersect",
              value: function value(entries, observer) {
                return _vm.onIntersect(entries, observer, obj);
              },
              ...
              value: {
                left: function left() {
                  return _vm.onSwipe('left', obj);
                },
                right: function right() {
                  return _vm.onSwipe('right', obj);
                },
                up: function up() {
                  return _vm.onSwipe('up', obj);
                },
                down: function down() {
                  return _vm.onSwipe('down', obj);
                }
              },
              ...
              value: function value(event) {
                return _vm.onClickOutside(event, obj);
              },
              expression: "(event) => onClickOutside(event, obj)"
            }],
            key: index,
            class: _vm.getClassName(obj),
            attrs: {
              "draggable": obj.schema.drag
            },
            on: {
              "mouseenter": function mouseenter($event) {
                return _vm.onEvent($event, obj);
              },
              "mouseleave": function mouseleave($event) {
                return _vm.onEvent($event, obj);
              },
              "dragstart": function dragstart($event) {
                return _vm.dragstart($event, obj);
              },
              "dragover": function dragover($event) {
                return _vm.dragover($event, obj);
              },
              "drop": function drop($event) {
                return _vm.drop($event, obj);
              }
            }
          }, 'v-col', _vm.getGridAttributes(obj), false), on), [_vm._t(_vm.getTypeTopSlot(obj), null, null, {
            obj: obj,
            index: index,
            id: _vm.id
          }), _vm._v(" "), _vm._t(_vm.getKeyTopSlot(obj), null, null, {
            obj: obj,
            index: index,
            id: _vm.id
          }), _vm._v(" "), _vm._t(_vm.getTypeItemSlot(obj), function () {
            return [_vm._t(_vm.getKeyItemSlot(obj), function () {
              return [obj.schema.type === 'radio' ? _c('v-radio-group', _vm._b({
                attrs: {
                  "value": _vm.setValue(obj)
                },
                on: {
                  "change": function change($event) {
                    return _vm.onInput($event, obj);
                  }
                }
              }, 'v-radio-group', _vm.bindSchema(obj), false), _vm._l(obj.schema.options, function (option, idx) {
                return _c('v-radio', _vm._b({
                  key: idx,
                  scopedSlots: _vm._u([_vm._l(_vm.getInjectedScopedSlots(_vm.id, obj), function (s) {
                    return {
                      key: s,
                      fn: function fn() {
                        return [_vm._t(_vm.getKeyInjectSlot(obj, s), null, null, {
                          id: _vm.id,
                          obj: obj,
                          index: index,
                          idx: idx,
                ...
                }, 'v-radio', _vm.bindOptions(option), false));
              }), 1) : _vm.isDateTimeColorTypeAndExtensionText(obj) ? _c('v-menu', _vm._b({
                scopedSlots: _vm._u([{
                  key: "activator",
                  fn: function fn(ref) {
                    var on = ref.on;
                    return [_c('v-text-field', _vm._g(_vm._b({
                      ...
                      on: _vm._d({
                        "click:append-outer": function clickAppendOuter($event) {
                          return _vm.onEvent($event, obj, _vm.appendOuter);
                        },
                        "click:prepend": function clickPrepend($event) {
                          return _vm.onEvent($event, obj, _vm.prepend);
                        },
                        "click:prepend-inner": function clickPrependInner($event) {
                          return _vm.onEvent($event, obj, _vm.prependInner);
                        }
                      }, [_vm.suspendClickAppend(obj), function ($event) {
                        return _vm.onEvent($event, obj, _vm.append);
                      }])
                    }, 'v-text-field', _vm.bindSchemaText(obj), false), on))];
                  }
                }], null, true)
              }, 'v-menu', _vm.bindSchemaMenu(obj), false), [_vm._v(" "), _c(_vm.mapTypeToComponent(obj.schema.type), _vm._b({
                tag: "component",
                attrs: {
                  "type": _vm.checkInternType(obj),
                  "value": _vm.setValue(obj)
                },
                on: {
                  ...
                  "click:hour": function clickHour($event) {
                    return _vm.onEvent({
                      type: 'click'
                    }, obj, _vm.hour);
                  },
                  ...
                  "click:second": function clickSecond($event) {
                    return _vm.onEvent({
                      type: 'click'
                    }, obj, _vm.second);
                  }
                }
              }, 'component', _vm.bindSchema(obj), false))], 1) : obj.schema.type === 'array' ? _vm._l(_vm.setValue(obj), function (item, idx) {
                return _c('div', _vm._b({
                  key: _vm.getKeyForArray(_vm.id, obj, item, idx),
                  attrs: {
                    "value": _vm.setValue(obj)
                  }
                }, 'div', _vm.bindSchema(obj), false), [_vm._t(_vm.getArrayTopSlot(obj), null, null, {
                  obj: obj,
                  id: _vm.id,
                  index: index,
                  idx: idx,
                  item: item
                }), _vm._v(" "), _vm._t(_vm.getArrayItemSlot(obj), function () {
                  return [_c('v-form-base', _vm._g({
                    class: _vm.id + "-" + obj.key,
                    attrs: {
                      "id": _vm.id + "-" + obj.key + "-" + idx,
                      "model": item,
                      "schema": obj.schema.schema,
                      "row": _vm.getRowGroupOrArray(obj),
                      "col": _vm.getColGroupOrArray(obj)
                    },
                    scopedSlots: _vm._u([_vm._l(_vm.$scopedSlots, function (_, name) {
                      return {
                        key: name,
                        fn: function fn(slotData) {
                          return [_vm._t(name, null, null, Object.assign({}, {
                            id: _vm.id,
                            obj: obj,
                            index: index,
                            idx: idx,
                  ...
                  idx: idx,
                  item: item
                }), _vm._v(" "), _vm._t(_vm.getArrayBottomSlot(obj), null, null, {
                  obj: obj,
                  id: _vm.id,
                  index: index,
                  idx: idx,
              ...
              }) : /(wrap|group)/.test(obj.schema.type) ? [_c(_vm.checkInternGroupType(obj), _vm._b({
                tag: "component",
                on: {
              ...
              }, 'component', _vm.bindSchema(obj), false), [obj.schema.title ? _c('v-card-title', [_vm._v("\n                    " + _vm._s(obj.schema.title) + "\n                  ")]) : _vm._e(), _vm._v(" "), obj.schema.subtitle ? _c('v-card-subtitle', [_vm._v("\n                    " + _vm._s(obj.schema.subtitle) + "\n                  ")]) : _vm._e(), _vm._v(" "), _c('v-form-base', _vm._g({
                class: _vm.id + "-" + obj.key,
                attrs: {
                  "id": _vm.id + "-" + obj.key,
                  "model": _vm.setValue(obj),
                  "schema": obj.schema.schema,
                  "row": _vm.getRowGroupOrArray(obj),
                  "col": _vm.getColGroupOrArray(obj)
                },
              ...
              }, _vm.$listeners))], 1)] : obj.schema.type === _vm.treeview ? _c('v-treeview', _vm._b({
                attrs: {
                  "items": _vm.setValue(obj),
                  "active": obj.schema.model,
                  "open": obj.schema.open
                },
                on: {
                  "update:active": [function ($event) {
                    return _vm.$set(obj.schema, "model", $event);
                  }, function ($event) {
                    return _vm.onEvent({
                      type: 'click'
                    }, obj, 'selected');
                  ...
                  "update:open": [function ($event) {
                    return _vm.$set(obj.schema, "open", $event);
                  }, function ($event) {
                    return _vm.onEvent({
                      type: 'click'
                    }, obj, 'open');
                ...
                scopedSlots: _vm._u([_vm._l(_vm.getInjectedScopedSlots(_vm.id, obj), function (s) {
                  return {
                    key: s,
                    fn: function fn(slotData) {
                      return [_vm._t(_vm.getKeyInjectSlot(obj, s), null, null, Object.assign({}, {
                        id: _vm.id,
                        obj: obj,
                        index: index
                      }, slotData))];
                ...
                model: {
                  value: obj.schema.model,
                  callback: function callback($$v) {
                    _vm.$set(obj.schema, "model", $$v);
                  },
                  expression: "obj.schema.model"
                }
              }, 'v-treeview', _vm.bindSchema(obj), false)) : obj.schema.type === _vm.list ? [_c('v-list', [_vm._t(_vm.getKeyInjectSlot(obj, 'label'), function () {
                return [obj.schema.label ? _c('v-toolbar', _vm._b({
                  attrs: {
                    "dark": ""
                  }
                }, 'v-toolbar', _vm.bindSchema(obj), false), [_c('v-toolbar-title', [_vm._v(_vm._s(obj.schema.label))])], 1) : _vm._e()];
              }, null, {
                id: _vm.id,
                obj: obj,
                index: index
              }), _vm._v(" "), _c('v-list-item-group', _vm._b({
                attrs: {
                  "light": ""
                },
                model: {
              ...
              }, 'v-list-item-group', _vm.bindSchema(obj), false), [_vm._l(_vm.setValue(obj), function (item, idx) {
                return [_c('v-list-item', {
                  key: idx,
                  on: {
                    "click": function click($event) {
                      return _vm.onEvent($event, obj, _vm.list);
                    }
                  }
                }, [_vm._t(_vm.getArrayItemSlot(obj), function () {
                  return [_c('v-list-item-icon', [_c('v-icon', {
                    domProps: {
                      "textContent": _vm._s(obj.schema.icon)
                    }
                  })], 1), _vm._v(" "), _c('v-list-item-content', [_c('v-list-item-title', {
                    domProps: {
                      "textContent": _vm._s(obj.schema.item ? item[obj.schema.item] : item)
                    }
                  })], 1)];
                }, null, {
                  obj: obj,
              ...
              })], 2)], 2)] : /(switch|checkbox)/.test(obj.schema.type) ? _c(_vm.mapTypeToComponent(obj.schema.type), _vm._b({
                tag: "component",
                attrs: {
                  "input-value": _vm.setValue(obj)
                },
                on: {
                  "change": function change($event) {
                    return _vm.onInput($event, obj);
              ...
              }, 'component', _vm.bindSchema(obj), false)) : obj.schema.type === 'file' ? _c('v-file-input', _vm._b({
                attrs: {
                  "value": _vm.setValue(obj)
                },
                on: {
              ...
              }, 'v-file-input', _vm.bindSchema(obj), false)) : obj.schema.type === 'icon' ? _c('v-icon', _vm._b({
                domProps: {
                  "textContent": _vm._s(_vm.getIconValue(obj))
                },
                on: {
                  "click": function click($event) {
                    return _vm.onEvent($event, obj);
              ...
              }, 'v-icon', _vm.bindSchema(obj), false)) : obj.schema.type === 'slider' ? _c('v-slider', _vm._b({
                on: {
                  "input": function input($event) {
                    return _vm.onInput($event, obj);
                  }
              ...
              }, 'v-slider', _vm.bindSchema(obj), false)) : obj.schema.type === 'img' ? _c('v-img', _vm._b({
                attrs: {
                  "src": _vm.getImageSource(obj)
                },
                on: {
                  "click": function click($event) {
                    return _vm.onEvent($event, obj);
              ...
              }, 'v-img', _vm.bindSchema(obj), false)) : obj.schema.type === 'btn-toggle' ? _c('v-btn-toggle', _vm._b({
                attrs: {
                  "value": _vm.setValue(obj)
                },
                on: {
              ...
              }, 'v-btn-toggle', _vm.bindSchema(obj), false), _vm._l(obj.schema.options, function (option, idx) {
                return _c('v-btn', _vm._b({
                  key: idx,
                  attrs: {
                    "icon": option.icon ? true : false
                  }
                }, 'v-btn', _vm.bindOptions(option), false), [_c('v-icon', {
                  attrs: {
                    "dark": obj.schema.dark
                  }
                }, [_vm._v("\n                    " + _vm._s(_vm.bindOptions(option).icon) + "\n                  ")]), _vm._v("\n                  " + _vm._s(_vm.bindOptions(option).label) + "\n                ")], 1);
              }), 1) : obj.schema.type === 'btn' ? _c('v-btn', _vm._b({
                on: {
                  "click": function click($event) {
                    return _vm.onEvent($event, obj, _vm.button);
                  }
                }
              }, 'v-btn', _vm.bindSchema(obj), false), [obj.schema.iconLeft ? _c('v-icon', {
                attrs: {
                  "left": "",
                  "dark": obj.schema.dark
                }
              }, [_vm._v("\n                  " + _vm._s(obj.schema.iconLeft) + "\n                ")]) : _vm._e(), _vm._v("\n                " + _vm._s(_vm.setValue(obj)) + "\n                "), obj.schema.iconCenter ? _c('v-icon', {
                attrs: {
                  "dark": obj.schema.dark
                }
              }, [_vm._v("\n                  " + _vm._s(obj.schema.iconCenter) + "\n                ")]) : _vm._e(), _vm._v("\n                " + _vm._s(obj.schema.label) + "\n                "), obj.schema.iconRight ? _c('v-icon', {
                attrs: {
                  "right": "",
                  "dark": obj.schema.dark
                }
              }, [_vm._v("\n                  " + _vm._s(obj.schema.iconRight) + "\n                ")]) : _vm._e()], 1) : obj.schema.mask ? _c(_vm.mapTypeToComponent(obj.schema.type), _vm._b(_vm._b({
                directives: [{
                  name: "mask",
                  rawName: "v-mask",
                  value: obj.schema.mask,
                  expression: "obj.schema.mask"
                }],
                tag: "component",
                attrs: {
                ...
                on: _vm._d({
                  ...
                  "click:clear": function clickClear($event) {
                    return _vm.onEvent($event, obj, _vm.clear);
                  },
                  "click:hour": function clickHour($event) {
                    return _vm.onEvent({
                      type: 'click'
                ...
                }, ["update:" + _vm.searchInputSync(obj), function ($event) {
                  return _vm.$set(obj.schema, "searchInput", $event);
                }, _vm.suspendClickAppend(obj), function ($event) {
                  return _vm.onEvent($event, obj, _vm.append);
                }]),
                scopedSlots: _vm._u([_vm._l(_vm.getInjectedScopedSlots(_vm.id, obj), function (s) {
              ...
              }, "component", _vm._d({}, [_vm.searchInputSync(obj), obj.schema.searchInput])), 'component', _vm.bindSchema(obj), false)) : _c(_vm.mapTypeToComponent(obj.schema.type), _vm._b(_vm._b({
                tag: "component",
                attrs: {
                  "type": _vm.checkExtensionType(obj),
                  "value": _vm.setValue(obj),
              ...
              }, "component", _vm._d({}, [_vm.searchInputSync(obj), obj.schema.searchInput])), 'component', _vm.bindSchema(obj), false))];
            }, null, {
              obj: obj,
              index: index,
              id: _vm.id
            ...
            index: index,
            id: _vm.id
          }), _vm._v(" "), _vm._t(_vm.getTypeBottomSlot(obj), null, null, {
            obj: obj,
            index: index,
            id: _vm.id
          }), _vm._v(" "), _vm._t(_vm.getKeyBottomSlot(obj), null, null, {
            obj: obj,
            index: index,
            id: _vm.id
          })], 2), _vm._v(" "), obj.schema.spacer ? _c('v-spacer', {
            key: "s-" + index
          }) : _vm._e()];
        }
      }], null, true)
    }, 'v-tooltip', _vm.getShorthandTooltip(obj.schema.tooltip), false), [_vm._v(" "), _vm._t(_vm.getTooltipSlot(obj), function () {
      return [_c('span', [_vm._v(_vm._s(_vm.getShorthandTooltipLabel(obj.schema.tooltip)))])];
    }, null, {
      obj: obj,
      index: index,
      id: _vm.id
    }), _vm._v(" "), _vm._t(_vm.getKeyTooltipSlot(obj), null, null, {
      obj: obj,
      index: index,
      id: _vm.id
    })], 2)];
  }), _vm._v(" "), _vm._t(_vm.getFormBottomSlot(), null, {
    "id": _vm.id
  })], 2);
};
